...
weight $p$. For $0 \le k < Q$ the next zero answer, at any fresh
...
started from $p_0 = 0.3$. Each confirmed answer divides the
...
\begin{tikzpicture}[x=1cm, y=1cm,
  ...
  \node[font=\scriptsize, anchor=north west] at (0.06,1.86)
    {spike};
  \draw[black!55] (0.25,0.35) -- (3.25,0.35);
  \fill[blue!45] (0.5,0.35) rectangle (0.78,0.575);
  \node[font=\scriptsize] at (0.64,0.76) {$p_0 = 0.3$};
  ...
  \node[font=\scriptsize] at (2.19,0.82) {$0.7$};

  \draw[state] (7,0) rectangle (10.5,1.9);
  \node[font=\scriptsize, anchor=north west] at (7.06,1.86)
    {uniform};
  ...
  \node[font=\scriptsize, anchor=north west] at (0.06,-1.24)
    {spike};
  \draw[black!55] (0.25,-2.75) -- (3.25,-2.75);
  \fill[blue!45] (0.5,-2.75) rectangle (0.78,-2.276);
  \node[font=\scriptsize] at (0.64,-2.09) {$p_1 = 0.632$};
  ...
  \node[font=\scriptsize] at (2.19,-2.28) {$0.368$};

  \draw[state] (7,-3.1) rectangle (10.5,-1.2);
  \node[font=\scriptsize, anchor=north west] at (7.06,-1.24)
    {uniform};
  ...
  \node[font=\scriptsize, anchor=north west] at (0.06,-4.34)
    {spike};
  \draw[black!55] (0.25,-5.85) -- (3.25,-5.85);
  \fill[blue!45] (0.5,-5.85) rectangle (0.78,-5.195);
  \node[font=\scriptsize] at (0.64,-5.0) {$p_2 = 0.873$};
  ...
  \node[font=\scriptsize] at (2.19,-5.38) {$0.127$};

  \draw[state] (7,-6.2) rectangle (10.5,-4.3);
  \node[font=\scriptsize, anchor=north west] at (7.06,-4.34)
    {uniform};
...
probabilities $P_k$ and $1 - P_k$, and the invariant $P_k p_k = p$ is
visible between the $P_k$ bars and the spike bars: the spike climbs
