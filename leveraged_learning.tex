...
\midrule
0  & FALSE                          & 0 & 0 & 1 & 2 & $-4$ & \pbarO{0.1106} & \pbarP{0.2799} \\
1  & $\lnot(b_1 \vee b_0)$ (NOR)    & 1 & 2 & 2 & 6 & $-2$ & \pbarO{0.0407} & \pbarP{0.0014} \\
2  & $\lnot b_1 \wedge b_0$         & 1 & 2 & 2 & 6 & $-2$ & \pbarO{0.0407} & \pbarP{0.0014} \\
3  & $\lnot b_1$                    & 0 & 1 & 2 & 5 & $0$  & \pbarO{0.1106} & \pbarP{0.0208} \\
4  & $b_1 \wedge \lnot b_0$         & 1 & 2 & 2 & 6 & $-2$ & \pbarO{0.0407} & \pbarP{0.0014} \\
5  & $\lnot b_0$                    & 0 & 1 & 2 & 5 & $0$  & \pbarO{0.1106} & \pbarP{0.0208} \\
6  & $b_1 \oplus b_0$ (XOR)         & 3 & 2 & 2 & 6 & $0$  & \pbarO{0.0055} & \pbarP{0.0001} \\
7  & $\lnot(b_1 \wedge b_0)$ (NAND) & 1 & 2 & 2 & 6 & $+2$ & \pbarO{0.0407} & \pbarP{0.0021} \\
8  & $b_1 \wedge b_0$ (AND)         & 1 & 2 & 2 & 6 & $-2$ & \pbarO{0.0407} & \pbarP{0.0014} \\
9  & $b_1 = b_0$ (XNOR)             & 3 & 2 & 2 & 6 & $0$  & \pbarO{0.0055} & \pbarP{0.0001} \\
10 & $b_0$ (projection)             & 0 & 1 & 2 & 5 & $0$  & \pbarO{0.1106} & \pbarP{0.0208} \\
11 & $b_1 \to b_0$                  & 1 & 2 & 2 & 6 & $+2$ & \pbarO{0.0407} & \pbarP{0.0021} \\
12 & $b_1$ (projection)             & 0 & 1 & 2 & 5 & $0$  & \pbarO{0.1106} & \pbarP{0.0208} \\
13 & $b_0 \to b_1$                  & 1 & 2 & 2 & 6 & $+2$ & \pbarO{0.0407} & \pbarP{0.0021} \\
14 & $b_1 \vee b_0$ (OR)            & 1 & 2 & 2 & 6 & $+2$ & \pbarO{0.0407} & \pbarP{0.0021} \\
15 & TRUE                           & 0 & 0 & 1 & 2 & $+4$ & \pbarO{0.1106} & \pbarP{0.6229} \\
\bottomrule
\end{tabular}
\end{center}
