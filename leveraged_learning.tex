...
\begin{tikzpicture}[line cap=round, line join=round]
  ...
  \draw[black!30, line width=0.9pt] (-1.951,0.1) -- (1.951,0.1);
  ...
  \foreach \ang/\col in {-6/red, -12/orange, -18/yellow!85!orange,
    ...
    \draw[\col, line width=1.6pt, -{Stealth[length=5pt]}]
      (1.951,0.1) -- ++(\ang:3.3);
  \node[font=\small] at (6.55,-1.20) {prediction};

  % name plate
  \node[font=\small] at (0,-2.72) {\textsc{Werner}};
\end{tikzpicture}
\caption{Werner the learner. One thin ray of surprisal enters his
prior and leaves spread across a broad fan of prediction: the
optical image of leverage, in which a narrow input is refracted into
a much wider output.}
\label{fig:werner}
\end{figure}
...
\begin{equation}\label{eq:telescope}
  \sum_{i=1}^{\ell} s_i \;=\; -\log_2 \Pr\big(\psi(\mathcal S) = \psi(\mathcal S)\big),
\end{equation}
...
\addplot[cpre, dotted, very thick] table[x=p, y=hbefore]
  {figures/data/spike_one_4to1.dat};
\addplot[cok] table[x=p, y=scorrect] {figures/data/spike_one_4to1.dat};
\addplot[cbad] table[x=p, y=swrong] {figures/data/spike_one_4to1.dat};
\addplot[cexp] table[x=p, y=sexpected] {figures/data/spike_one_4to1.dat};
\addplot[cok, dashed] table[x=p, y=hcorrect]
  {figures/data/spike_one_4to1.dat};
\addplot[cbad, dashed] table[x=p, y=hwrong]
  {figures/data/spike_one_4to1.dat};
\addplot[cexp, dashed] table[x=p, y=hexpected]
  {figures/data/spike_one_4to1.dat};
\legend{{before}, {$s_{\rm correct}$}, {$s_{\rm wrong}$},
...
\addplot[cpre, dotted, very thick] table[x=p, y=hbefore]
  {figures/data/spike_one_3to2.dat};
\addplot[cok] table[x=p, y=scorrect] {figures/data/spike_one_3to2.dat};
\addplot[cbad] table[x=p, y=swrong] {figures/data/spike_one_3to2.dat};
\addplot[cexp] table[x=p, y=sexpected] {figures/data/spike_one_3to2.dat};
\addplot[cok, dashed] table[x=p, y=hcorrect]
  {figures/data/spike_one_3to2.dat};
\addplot[cbad, dashed] table[x=p, y=hwrong]
  {figures/data/spike_one_3to2.dat};
...
\addplot[cok, thick] table[x=p, y=lcorrect]
  {figures/data/spike_lev_4to1.dat};
\addplot[cbad, thick] table[x=p, y=lwrong]
  {figures/data/spike_lev_4to1.dat};
\addplot[cexp, thick] table[x=p, y=lexpected]
  {figures/data/spike_lev_4to1.dat};
\legend{{uniform baseline $L=1$}, {correct}, {wrong}, {expected}}
\end{axis}
\end{tikzpicture}\hfill
\begin{tikzpicture}[baseline=(current bounding box.north)]
\begin{axis}[width=7.4cm, height=5.4cm,
...
\addplot[cpre, dotted, thick, domain=0:1] {1};
\addplot[cok, thick] table[x=p, y=lcorrect]
  {figures/data/spike_lev_3to2.dat};
\addplot[cbad, thick] table[x=p, y=lwrong]
  {figures/data/spike_lev_3to2.dat};
\addplot[cexp, thick] table[x=p, y=lexpected]
  {figures/data/spike_lev_3to2.dat};
...
\begin{axis}[width=7.4cm, height=5.4cm,
  ...
  legend style={font=\tiny, at={(0.5,-0.22)}, anchor=north, legend columns=5},
  legend cell align=left]
\addplot[cf1] table[x=p, y=ratio] {figures/data/extraction_n2.dat};
\addplot[cf2] table[x=p, y=ratio] {figures/data/extraction_n3.dat};
\addplot[cf3] table[x=p, y=ratio] {figures/data/extraction_n4.dat};
\addplot[cf4] table[x=p, y=ratio] {figures/data/extraction_n5.dat};
\addplot[cf5] table[x=p, y=ratio] {figures/data/extraction_n6.dat};
...
\begin{axis}[width=7.4cm, height=5.4cm,
  ...
  legend style={font=\tiny, at={(0.5,-0.22)}, anchor=north, legend columns=5},
  legend cell align=left]
\addplot[cf1] table[x=p, y=ratio] {figures/data/extraction_m1.dat};
\addplot[cf2] table[x=p, y=ratio] {figures/data/extraction_m2.dat};
\addplot[cf3] table[x=p, y=ratio] {figures/data/extraction_m3.dat};
\addplot[cf4] table[x=p, y=ratio] {figures/data/extraction_m4.dat};
...
\begin{axis}[width=5.1cm, height=5.2cm,
  ...
  legend cell align=left]
\addplot[cf1] table[x=x, y=lev] {figures/data/spikeflow_sharp_n3.dat};
\addplot[cf2] table[x=x, y=lev] {figures/data/spikeflow_sharp_n4.dat};
\addplot[cf3] table[x=x, y=lev] {figures/data/spikeflow_sharp_n5.dat};
\addplot[cf4] table[x=x, y=lev] {figures/data/spikeflow_sharp_n6.dat};
\addplot[cf5] table[x=x, y=lev] {figures/data/spikeflow_sharp_n8.dat};
\addplot[black!55] table[x=x, y=lev] {figures/data/spikeflow_sharp_n10.dat};
\addplot[black, dashed, domain=0:1] {0.5};
\legend{{$n=3$}, {$n=4$}, {$n=5$}, {$n=6$}, {$n=8$}, {$n=10$},
  {$1-2^{-m}$}}
\end{axis}
\end{tikzpicture}\hfill
\begin{tikzpicture}[baseline=(current bounding box.north)]
\begin{axis}[width=5.1cm, height=5.2cm,
  ...
  legend style={font=\tiny, at={(0.97,0.97)}, anchor=north east},
  legend cell align=left]
\addplot[cf1] table[x=x, y=e2] {figures/data/spikeflow_eps.dat};
\addplot[cf2] table[x=x, y=e4] {figures/data/spikeflow_eps.dat};
\addplot[cf3] table[x=x, y=e8] {figures/data/spikeflow_eps.dat};
\addplot[cf4] table[x=x, y=e12] {figures/data/spikeflow_eps.dat};
\addplot[black, dashed] table[x=x, y=sharp] {figures/data/spikeflow_eps.dat};
\legend{{$10^{-2}$}, {$10^{-4}$}, {$10^{-8}$}, {$10^{-12}$},
  {sharp limit}}
\end{axis}
\end{tikzpicture}
...
\begin{axis}[width=7.4cm, height=5.4cm,
  ...
  legend style={font=\tiny, at={(0.97,0.97)}, anchor=north east},
  legend cell align=left]
\addplot[cn1] table[x=x, y=lev] {figures/data/cointwo_n4.dat};
\addplot[cn2] table[x=x, y=lev] {figures/data/cointwo_n6.dat};
\addplot[cn3] table[x=x, y=lev] {figures/data/cointwo_n8.dat};
\addplot[cn4] table[x=x, y=lev] {figures/data/cointwo_n10.dat};
\addplot[clim, dashed, thick, domain=0.15:1, samples=80]
  {1+1.132216/x};
\legend{{$n=4$}, {$n=6$}, {$n=8$}, {$n=10$}, {$1+c_1/x$}}
\end{axis}
\end{tikzpicture}\hfill
\begin{tikzpicture}[baseline=(current bounding box.north)]
\begin{axis}[width=7.4cm, height=5.4cm,
  ...
  tick label style={font=\scriptsize}, label style={font=\small},
  grid=major, grid style={black!12}]
\addplot[cn1] table[x=x, y=lev] {figures/data/cointen_n4.dat};
\addplot[cn2] table[x=x, y=lev] {figures/data/cointen_n6.dat};
\addplot[cn3] table[x=x, y=lev] {figures/data/cointen_n8.dat};
\addplot[cn4] table[x=x, y=lev] {figures/data/cointen_n10.dat};
\addplot[clim, dashed, thick, domain=0.15:1, samples=80]
  {1+1.132216/x};
\end{axis}
\end{tikzpicture}
...
\begin{axis}[width=7.4cm, height=5.4cm,
  ...
  legend style={font=\tiny, at={(0.97,0.97)}, anchor=north east},
  legend cell align=left]
\addplot[cn1] table[x=x, y=lev] {figures/data/coinm1_n4.dat};
\addplot[cn2] table[x=x, y=lev] {figures/data/coinm1_n6.dat};
\addplot[cn3] table[x=x, y=lev] {figures/data/coinm1_n8.dat};
\addplot[cn4] table[x=x, y=lev] {figures/data/coinm1_n10.dat};
\addplot[clim, dashed, thick, domain=0.15:1, samples=80] {1+1.132216/x};
\legend{{$n=4$}, {$n=6$}, {$n=8$}, {$n=10$}, {$1+c_m/x$}}
\end{axis}
\end{tikzpicture}\hfill
\begin{tikzpicture}[baseline=(current bounding box.north)]
\begin{axis}[width=7.4cm, height=5.4cm,
  ...
  tick label style={font=\scriptsize}, label style={font=\small},
  grid=major, grid style={black!12}]
\addplot[cn1] table[x=x, y=lev] {figures/data/coinm2_n4.dat};
\addplot[cn2] table[x=x, y=lev] {figures/data/coinm2_n6.dat};
\addplot[cn3] table[x=x, y=lev] {figures/data/coinm2_n8.dat};
\addplot[cn4] table[x=x, y=lev] {figures/data/coinm2_n10.dat};
...
\begin{axis}[width=9.4cm, height=5.2cm,
  ...
  legend style={font=\scriptsize, at={(0.5,0.97)}, anchor=north,
    legend columns=4},
  legend cell align=left]
\addplot[cn1, thick] table[x=x, y=b0] {figures/data/bernstein3.dat};
\addplot[cn2, thick] table[x=x, y=b1] {figures/data/bernstein3.dat};
\addplot[cn3, thick] table[x=x, y=b2] {figures/data/bernstein3.dat};
\addplot[cn4, thick] table[x=x, y=b3] {figures/data/bernstein3.dat};
\legend{$\beta_{3,0}$, $\beta_{3,1}$, $\beta_{3,2}$, $\beta_{3,3}$}
\end{axis}
\end{tikzpicture}
...
\begin{axis}[width=4.05cm, height=4.6cm,
  ...
  grid=major, grid style={black!12}]
\addplot[cn3] table[x=x, y=lev] {figures/data/zoo_clique_r2.dat};
\addplot[cn3] table[x=x, y=lev] {figures/data/zoo_clique_r4.dat};
...
\begin{axis}[width=4.05cm, height=4.6cm,
  ...
  tick label style={font=\tiny}, label style={font=\scriptsize},
  grid=major, grid style={black!12}]
\addplot[cn1] table[x=x, y=lev] {figures/data/zoo_parity_n6.dat};
\addplot[cn3] table[x=x, y=lev] {figures/data/zoo_parity_n8.dat};
\addplot[cn4] table[x=x, y=lev] {figures/data/zoo_parity_n10.dat};
...
\begin{axis}[width=4.05cm, height=4.6cm,
  ...
  tick label style={font=\tiny}, label style={font=\scriptsize},
  grid=major, grid style={black!12}]
\addplot[cn1] table[x=x, y=lev] {figures/data/zoo_mds_n6.dat};
\addplot[cn3] table[x=x, y=lev] {figures/data/zoo_mds_n8.dat};
\addplot[cn4] table[x=x, y=lev] {figures/data/zoo_mds_n10.dat};
\addplot[clim, dashed] table[x=x, y=lev]
  {figures/data/zoo_mds_limit.dat};
\end{axis}
\end{tikzpicture}\hfill
\begin{tikzpicture}[baseline=(current bounding box.north)]
\begin{axis}[width=4.05cm, height=4.6cm,
  ...
  tick label style={font=\tiny}, label style={font=\scriptsize},
  grid=major, grid style={black!12}]
\addplot[cn1] table[x=x, y=lev] {figures/data/zoo_cocktail_n6.dat};
\addplot[cn3] table[x=x, y=lev] {figures/data/zoo_cocktail_n8.dat};
\addplot[cn4] table[x=x, y=lev] {figures/data/zoo_cocktail_n10.dat};
\addplot[clim, dashed] table[x=x, y=lev]
  {figures/data/zoo_cocktail_limit.dat};
\end{axis}
\end{tikzpicture}
