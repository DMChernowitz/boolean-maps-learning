...
\end{equation}
%
Applying it to $\psi(\mathcal S)$ and one fresh answer $\psi(q)$,
$q \in \mathcal Q \setminus \mathcal S$,
with $i \notin \mathcal S$, and averaging over the externally
selected questions, gives
%
\begin{equation}
  \gamma_{n,k}
  \;=\; \mathbb E_{\mathcal S, i}
...
while $\mathbb E_{\mathcal S, i}$ averages that entropy over which
