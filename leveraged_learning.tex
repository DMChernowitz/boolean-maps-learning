...
\begin{tikzpicture}[x=1cm, y=1cm,
  ...
  % ---------------- row k = 0 ----------------
  \node[font=\small] at (1.75,2.35) {$P_0 = 1$};
  ...
  \fill[blue!45] (1.3,0.35) rectangle (1.58,0.385);
  \node[font=\scriptsize] at (1.44,0.56) {$\omega$};
  \node[font=\scriptsize, align=left, anchor=west] at (1.8,0.82)
    {$1 - p_0 = 0.7$\\[-2pt] on $65{,}535$ maps};

  \draw[state] (7,0) rectangle (10.5,1.9);
  \node[font=\scriptsize, anchor=north west] at (7.06,1.86)
    {uniform, $65{,}536$ maps};
  \draw[black!55] (7.3,0.35) -- (10.2,0.35);
  \foreach \xx in {7.7,8.25} \fill[blue!45]
    (\xx,0.35) rectangle (\xx+0.28,0.62);
  \node at (8.75,0.47) {$\cdots$};
  \foreach \xx in {8.97,9.52} \fill[blue!45]
    (\xx,0.35) rectangle (\xx+0.28,0.62);

  % ---------------- transitions 0 -> 1 ----------------
  \draw[flow] (1.75,0) -- (1.75,-1.2)
    node[alab, midway, left=1pt] {$P_1/P_0 = 0.475$};
  \draw[flow] (3.1,0) -- (7.6,-1.2)
    node[alab, pos=0.45] {$1 - P_1/P_0 = 0.525$};
  \draw[flow] (8.75,0) -- (8.75,-1.2)
    node[alab, midway, right=1pt] {$1$};
  ...
  \fill[blue!45] (1.3,-2.75) rectangle (1.58,-2.71);
  \node[font=\scriptsize] at (1.44,-2.54) {$\omega_1$};
  \node[font=\scriptsize, align=left, anchor=west] at (1.8,-2.28)
    {$1 - p_1 = 0.368$\\[-2pt] on $16{,}383$ maps};
  ...
  \node at (8.75,-2.63) {$\cdots$};
  \foreach \xx in {8.97,9.52} \fill[blue!45]
    (\xx,-2.75) rectangle (\xx+0.28,-2.48);

  % ---------------- transitions 1 -> 2 ----------------
  \draw[flow] (1.75,-3.1) -- (1.75,-4.3)
    node[alab, midway, left=1pt] {$P_2/P_1 = 0.724$};
  \draw[flow] (3.1,-3.1) -- (7.6,-4.3)
    node[alab, pos=0.45] {$1 - P_2/P_1 = 0.276$};
  ...
  \fill[blue!45] (1.3,-5.85) rectangle (1.58,-5.81);
  \node[font=\scriptsize] at (1.44,-5.64) {$\omega_2$};
  \node[font=\scriptsize, align=left, anchor=west] at (1.8,-5.38)
    {$1 - p_2 = 0.127$\\[-2pt] on $4{,}095$ maps};
...
The two columns are the macrostates of \eqref{eq:spikeflow}, the
arrows carry the transition probabilities, and each row's map space
is one quarter of the row above. The invariant $P_k p_k = p$ is
visible down the left column: the spike bar climbs exactly as fast
as its branch loses probability, $0.3 = 1 \times 0.3 = 0.475 \times
0.632 = 0.344 \times 0.873$.
\end{example}
