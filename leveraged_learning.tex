...
\begin{tikzpicture}[x=1cm, y=1cm,
  ...
  \node[font=\scriptsize, align=center] at (0.64,0.98) {$p_0$\\[-2pt]$0.3$};
  ...
  \node[font=\scriptsize, align=center] at (2.55,1.5) {$1-p_0$\\[-2pt]$0.7$};
  ...
  \node[font=\scriptsize] at (8.75,0.85) {$p_j$};
  ...
  \node[font=\scriptsize, align=center] at (0.64,-1.9) {$p_1$\\[-2pt]$0.632$};
  ...
  \node[font=\scriptsize, align=center] at (2.55,-1.6) {$1-p_1$\\[-2pt]$0.368$};
  ...
  \node[font=\scriptsize] at (8.75,-2.25) {$p_j$};
  \foreach \xx in {9.4,9.95} \fill[blue!45]
    (\xx,-2.75) rectangle (\xx+0.28,-2.48);
  ...
  \node[font=\scriptsize, align=center] at (0.64,-4.82) {$p_2$\\[-2pt]$0.873$};
  ...
  \node[font=\scriptsize, align=center] at (2.55,-4.7) {$1-p_2$\\[-2pt]$0.127$};
  ...
  \node[font=\scriptsize] at (8.75,-5.35) {$p_j$};
  \foreach \xx in {9.4,9.95} \fill[blue!45]
    (\xx,-5.85) rectangle (\xx+0.28,-5.58);
