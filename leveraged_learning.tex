...
\begin{center}
\begin{tabular}{c |cccc| l c}
\toprule
 & \multicolumn{4}{|c|}{$\phi_j(q)$} & & \\
$j$ & $11$ & $10$ & $01$ & $00$ & name & $p_j$ \\
\midrule
0  & 0 & 0 & 0 & 0 & FALSE (constant $0$) & 0.150 \\
1  & 0 & 0 & 0 & 1 & $\lnot(b_1 \vee b_0)$ (NOR) & 0.141 \\
2  & 0 & 0 & 1 & 0 & $\lnot b_1 \wedge b_0$ & 0.060 \\
3  & 0 & 0 & 1 & 1 & $\lnot b_1$ & 0.017 \\
4  & 0 & 1 & 0 & 0 & $b_1 \wedge \lnot b_0$ & 0.094 \\
5  & 0 & 1 & 0 & 1 & $\lnot b_0$ & 0.015 \\
6  & 0 & 1 & 1 & 0 & $b_1 \oplus b_0$ (XOR) & 0.012 \\
7  & 0 & 1 & 1 & 1 & $\lnot(b_1 \wedge b_0)$ (NAND) & 0.011 \\
8  & 1 & 0 & 0 & 0 & $b_1 \wedge b_0$ (AND) & 0.149 \\
9  & 1 & 0 & 0 & 1 & $b_1 = b_0$ (XNOR) & 0.114 \\
10 & 1 & 0 & 1 & 0 & $b_0$ (projection) & 0.082 \\
11 & 1 & 0 & 1 & 1 & $b_1 \to b_0$ (IF THEN) & 0.016 \\
12 & 1 & 1 & 0 & 0 & $b_1$ (projection) & 0.102 \\
13 & 1 & 1 & 0 & 1 & $b_0 \to b_1$ (IF THEN) & 0.013 \\
14 & 1 & 1 & 1 & 0 & $b_1 \vee b_0$ (OR) & 0.014 \\
...
\[
  \begin{array}{c|cccc}
    \mathbf{a}\backslash\mathbf{q} & \mathbf{11} & \mathbf{10} & \mathbf{01} & \mathbf{00} \\
    \hline
    \mathbf{0} & 0.500 & 0.729 & 0.778 & 0.663 \\[2pt]
    \mathbf{1} & 0.500 & 0.271 & 0.222 & 0.337 \\
    \hline
    \langle s \rangle & 1.000 & 0.843 & 0.764 & 0.922 \\[2pt]
    \langle \Delta H(M) \rangle & 1.005 & 0.878 & 0.778 & 0.965
  \end{array}
\]
...
$j$ & name & $p_j$ & $p'_j$ \\
\midrule
\tikzmark{w1a}0 & FALSE (constant $0$) & 0.150 & ---\tikzmark{w1ae} \\
\tikzmark{w1b}1 & $\lnot(b_1 \vee b_0)$ (NOR) & 0.141 & ---\tikzmark{w1be} \\
\tikzmark{w1c}2 & $\lnot b_1 \wedge b_0$ & 0.060 & ---\tikzmark{w1ce} \\
\tikzmark{w1d}3 & $\lnot b_1$ & 0.017 & ---\tikzmark{w1de} \\
\tikzmark{w1e}4 & $b_1 \wedge \lnot b_0$ & 0.094 & ---\tikzmark{w1ee} \\
\tikzmark{w1f}5 & $\lnot b_0$ & 0.015 & ---\tikzmark{w1fe} \\
\tikzmark{w1g}6 & $b_1 \oplus b_0$ (XOR) & 0.012 & ---\tikzmark{w1ge} \\
\tikzmark{w1h}7 & $\lnot(b_1 \wedge b_0)$ (NAND) & 0.011 & ---\tikzmark{w1he} \\
8 & $b_1 \wedge b_0$ (AND) & 0.149 & 0.298 \\
9 & $b_1 = b_0$ (XNOR) & 0.114 & 0.228 \\
10 & $b_0$ (projection) & 0.082 & 0.164 \\
11 & $b_1 \to b_0$ (IF THEN) & 0.016 & 0.032 \\
12 & $b_1$ (projection) & 0.102 & 0.204 \\
13 & $b_0 \to b_1$ (IF THEN) & 0.013 & 0.026 \\
14 & $b_1 \vee b_0$ (OR) & 0.014 & 0.028 \\
15 & TRUE (constant $1$) & 0.010 & 0.020 \\
\bottomrule
\end{tabular}
\begin{tikzpicture}[overlay, remember picture]
...
the deduced part is \emph{negative}, $-0.014$ bits. The realized
answer nudged the unasked columns slightly toward the fair coin ---
correlations point the right way only on average, not on every draw.
...
\[
  \begin{array}{c|cccc}
    \mathbf{a}\backslash\mathbf{q} & \mathbf{11} & \mathbf{10} & \mathbf{01} & \mathbf{00} \\
    \hline
    \mathbf{0} & 0 & 0.722 & 0.756 & 0.694 \\[2pt]
    \mathbf{1} & 1 & 0.278 & 0.244 & 0.306 \\
    \hline
    \langle s \rangle & \text{---} & 0.853 & 0.802 & 0.889 \\[2pt]
    \langle \Delta H(M) \rangle & \text{---} & 0.889 & 0.820 & 0.926
  \end{array}
\]
...
$j$ & name & $p_j$ & $p'_j$ \\
\midrule
8 & $b_1 \wedge b_0$ (AND) & 0.298 & 0.429 \\
\tikzmark{w2a}9 & $b_1 = b_0$ (XNOR) & 0.228 & ---\tikzmark{w2ae} \\
10 & $b_0$ (projection) & 0.164 & 0.236 \\
\tikzmark{w2b}11 & $b_1 \to b_0$ (IF THEN) & 0.032 & ---\tikzmark{w2be} \\
12 & $b_1$ (projection) & 0.204 & 0.294 \\
\tikzmark{w2c}13 & $b_0 \to b_1$ (IF THEN) & 0.026 & ---\tikzmark{w2ce} \\
14 & $b_1 \vee b_0$ (OR) & 0.028 & 0.040 \\
\tikzmark{w2d}15 & TRUE (constant $1$) & 0.020 & ---\tikzmark{w2de} \\
\bottomrule
\end{tabular}
\begin{tikzpicture}[overlay, remember picture]
...
\[
  \begin{array}{c|cccc}
    \mathbf{a}\backslash\mathbf{q} & \mathbf{11} & \mathbf{10} & \mathbf{01} & \mathbf{00} \\
    \hline
    \mathbf{0} & 0 & 0.666 & 0.723 & 1 \\[2pt]
    \mathbf{1} & 1 & 0.334 & 0.277 & 0 \\
    \hline
    \langle s \rangle & \text{---} & 0.919 & 0.851 & \text{---} \\[2pt]
    \langle \Delta H(M) \rangle & \text{---} & 0.968 & 0.899 & \text{---}
  \end{array}
\]
...
$j$ & name & $p_j$ & $p'_j$ \\
\midrule
8 & $b_1 \wedge b_0$ (AND) & 0.429 & 0.645 \\
10 & $b_0$ (projection) & 0.236 & 0.355 \\
\tikzmark{w3a}12 & $b_1$ (projection) & 0.294 & ---\tikzmark{w3ae} \\
\tikzmark{w3b}14 & $b_1 \vee b_0$ (OR) & 0.040 & ---\tikzmark{w3be} \\
\bottomrule
\end{tabular}
\begin{tikzpicture}[overlay, remember picture]
...
\[
  \begin{array}{c|cccc}
    \mathbf{a}\backslash\mathbf{q} & \mathbf{11} & \mathbf{10} & \mathbf{01} & \mathbf{00} \\
    \hline
    \mathbf{0} & 0 & 1 & 0.645 & 1 \\[2pt]
    \mathbf{1} & 1 & 0 & 0.355 & 0 \\
    \hline
    \langle s \rangle & \text{---} & \text{---} & 0.938 & \text{---} \\[2pt]
    \langle \Delta H(M) \rangle & \text{---} & \text{---} & 0.938 & \text{---}
  \end{array}
\]
...
$j$ & name & $p_j$ & $p'_j$ \\
\midrule
8 & $b_1 \wedge b_0$ (AND) & 0.645 & 1.000 \\
\tikzmark{w4a}10 & $b_0$ (projection) & 0.355 & ---\tikzmark{w4ae} \\
\bottomrule
\end{tabular}
\begin{tikzpicture}[overlay, remember picture]
  \draw[line width=0.5pt]
...
stacks the books after each question: what remains, what was
received, and the deduced gap up to the initial total.
...
\begin{tikzpicture}[x=1.35cm, y=1.05cm]
  ...
  \fill[green!55!black] (1.68,3.297) rectangle (2.32,3.529);
  % l = 3
  \fill[blue!55] (2.68,0) rectangle (3.32,0.938);
  \fill[orange!85] (2.68,0.938) rectangle (3.32,3.052);
  \fill[green!55!black] (2.68,3.052) rectangle (3.32,3.529);
  % l = 4
  \fill[orange!85] (3.68,0) rectangle (4.32,2.747);
  \fill[green!55!black] (3.68,2.747) rectangle (4.32,3.529);
  % initial-total line
  ...
  \fill[green!55!black] (5.4,1.7) rectangle (5.7,1.95);
  \node[right, font=\small] at (5.7,1.82) {deduced};
\end{tikzpicture}
\captionof{figure}{The realized run through the guiding example:
remaining table entropy, cumulative surprisal received, and the
deduced remainder, after each question. The three parts sum to
$H(M)_0 = 3.529$ at every step. At $\ell = 1$ the deduced part is
in fact slightly negative ($-0.014$ bits): the received bar pokes
just above the $H(M)_0$ line, invisibly at this scale.}
\label{fig:run21}
\end{center}
\end{example}
