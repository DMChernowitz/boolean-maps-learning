...
\midrule
0  & FALSE                          & 0 & 0 & 1 & 2 & $-4$ & \pbarO{0.1106} & \pbarP{0.0780} \\
1  & $\lnot(b_1 \vee b_0)$ (NOR)    & 1 & 2 & 2 & 6 & $-2$ & \pbarO{0.0407} & \pbarP{0.0006} \\
2  & $\lnot b_1 \wedge b_0$         & 1 & 2 & 2 & 6 & $-2$ & \pbarO{0.0407} & \pbarP{0.0006} \\
3  & $\lnot b_1$                    & 0 & 1 & 2 & 5 & $0$  & \pbarO{0.1106} & \pbarP{0.0129} \\
4  & $b_1 \wedge \lnot b_0$         & 1 & 2 & 2 & 6 & $-2$ & \pbarO{0.0407} & \pbarP{0.0006} \\
5  & $\lnot b_0$                    & 0 & 1 & 2 & 5 & $0$  & \pbarO{0.1106} & \pbarP{0.0129} \\
6  & $b_1 \oplus b_0$ (XOR)         & 3 & 2 & 2 & 6 & $0$  & \pbarO{0.0055} & \pbarP{0.0001} \\
7  & $\lnot(b_1 \wedge b_0)$ (NAND) & 1 & 2 & 2 & 6 & $+2$ & \pbarO{0.0407} & \pbarP{0.0019} \\
8  & $b_1 \wedge b_0$ (AND)         & 1 & 2 & 2 & 6 & $-2$ & \pbarO{0.0407} & \pbarP{0.0006} \\
9  & $b_1 = b_0$ (XNOR)             & 3 & 2 & 2 & 6 & $0$  & \pbarO{0.0055} & \pbarP{0.0001} \\
10 & $b_0$ (projection)             & 0 & 1 & 2 & 5 & $0$  & \pbarO{0.1106} & \pbarP{0.0129} \\
11 & $b_1 \to b_0$                  & 1 & 2 & 2 & 6 & $+2$ & \pbarO{0.0407} & \pbarP{0.0019} \\
12 & $b_1$ (projection)             & 0 & 1 & 2 & 5 & $0$  & \pbarO{0.1106} & \pbarP{0.0129} \\
13 & $b_0 \to b_1$                  & 1 & 2 & 2 & 6 & $+2$ & \pbarO{0.0407} & \pbarP{0.0019} \\
14 & $b_1 \vee b_0$ (OR)            & 1 & 2 & 2 & 6 & $+2$ & \pbarO{0.0407} & \pbarP{0.0019} \\
15 & TRUE                           & 0 & 0 & 1 & 2 & $+4$ & \pbarO{0.1106} & \pbarP{0.8602} \\
\bottomrule
\end{tabular}
\end{center}
...
footprint and rewarding ones, piles $0.86$ of its mass onto TRUE and
all but abandons the interior of the table. Grouped by the full
tuple $(X, F, B)$, the sixteen maps fall into six energy classes:
...
and the tilt $\mu = -0.3$ leans toward $1$-heavy tables, breaking
...
afford to compute it, it reproduces the fixed optimum's curve --
exactly, to machine precision, in the complexity-only settings, and
to plotting resolution for the Pragmatist -- a coincidence for which
we have no symmetry argument yet (at $(4,1)$ its $3^{16}$-state
program is in any case out of reach). Two anchors
...
\centering
\begin{tikzpicture}
\begin{axis}[width=4.7cm, height=4.8cm,
...
\begin{tikzpicture}
\begin{axis}[width=4.7cm, height=4.8cm,
  title={Pragmatist $(1.5,1,-0.3)$}, title style={font=\footnotesize},
  xlabel={$\ell$}, xtick={1,2,3,4}, grid=major,
  grid style={black!12},
  tick label style={font=\scriptsize}, label style={font=\small}]
\addplot[black!60, densely dashed, mark=*, mark size=1.1]
  coordinates {(1,2.7340)(2,2.3994)(3,2.2733)(4,2.2038)};
\addplot[blue!45, mark=square*, mark size=1.3]
  coordinates {(1,2.7340)(2,2.3666)(3,2.2733)(4,2.2038)};
\addplot[blue!75!black, mark=triangle*, mark size=1.4]
  coordinates {(1,2.7340)(2,2.3666)(3,2.2733)(4,2.2038)};
\addplot[orange!85!black, mark=diamond*, mark size=1.6]
  coordinates {(1,2.7340)(2,2.3666)};
\end{axis}
\end{tikzpicture}
...
\begin{axis}[width=4.7cm, height=4.8cm,
  ...
  tick label style={font=\scriptsize}, label style={font=\small}]
\addplot[black!60, densely dashed, mark=*, mark size=1.1]
  coordinates {(1,4.5909)(2,3.9528)(3,3.6789)(4,3.5143)(5,3.3954)
    (6,3.3084)(7,3.2496)(8,3.2142)};
\addplot[blue!45, mark=square*, mark size=1.3]
  coordinates {(1,4.5909)(2,3.9310)(3,3.6716)(4,3.4893)(5,3.3449)
    (6,3.2929)(7,3.2496)(8,3.2142)};
\addplot[blue!75!black, mark=triangle*, mark size=1.4]
  coordinates {(1,4.5909)(2,3.9278)(3,3.6575)(4,3.4624)(5,3.3171)
    (6,3.2658)(7,3.2328)(8,3.2142)};
\addplot[orange!85!black, mark=diamond*, mark size=1.6]
  coordinates {(1,4.5909)(2,3.9069)(3,3.6177)(4,3.4060)};
\end{axis}
\end{tikzpicture}
...
\begin{axis}[width=4.7cm, height=4.8cm,
  ...
  tick label style={font=\scriptsize}, label style={font=\small}]
\addplot[black!60, densely dashed, mark=*, mark size=1.1]
  coordinates {(1,4.8626)(2,4.3940)(3,4.1564)(4,3.9917)(5,3.8649)
    (6,3.7639)(7,3.6822)(8,3.6150)(9,3.5588)(10,3.5109)(11,3.4696)
    (12,3.4341)(13,3.4039)(14,3.3790)(15,3.3591)(16,3.3440)};
\addplot[blue!45, mark=square*, mark size=1.3]
  coordinates {(1,4.8626)(2,4.5671)(3,4.1784)(4,3.9311)(5,3.8001)
    (6,3.6805)(7,3.5962)(8,3.5099)(9,3.4838)(10,3.4581)(11,3.4350)
    (12,3.4125)(13,3.3933)(14,3.3745)(15,3.3591)(16,3.3440)};
\addplot[blue!75!black, mark=triangle*, mark size=1.4]
  coordinates {(1,4.8626)(2,4.5316)(3,4.1541)(4,3.9054)(5,3.7596)
    (6,3.6372)(7,3.5394)(8,3.4626)(9,3.4301)(10,3.4046)(11,3.3846)
    (12,3.3714)(13,3.3614)(14,3.3527)(15,3.3478)(16,3.3440)};
\addplot[orange!85!black, mark=diamond*, mark size=1.6]
  coordinates {(1,4.8626)(2,4.3832)(3,4.1349)(4,3.9548)(5,3.8086)
    (6,3.6906)(7,3.5962)(8,3.5099)};
\end{axis}
\end{tikzpicture}
\caption{Expected leverage under the Gibbs priors at $(4,1)$,
$\ell^* = 8$. Occamer's deep store bends even the strategyless
average curve into an interior hump; the Pragmatist is a near-spike
on TRUE, all leverage and almost no game.}
\label{fig:gibbs41}
\end{figure}
...
finally misses: its set $\{000, 011, 100, 101\}$ leaves twice the
ignorance of the optimal four ($0.132$ against $0.066$ bits
remaining) while receiving $0.032$ bits less -- and it posts the
\emph{higher} leverage, $3.489$ against $3.406$, with the
strategyless average higher still at $3.514$. The $\ell$-optimal
...
Pragmatist -- whose prior, $0.86$ of its mass on TRUE, is a spike in
disguise: $H(p) = 0.043$ bits, leverage running from $4.86$ down to
$3.34$, a great deal of inference about a game that is nearly over
before it starts.
